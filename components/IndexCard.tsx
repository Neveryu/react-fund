  ...
  return (
    <div
      ...
      className={cn(
        ...
        onClick && 'cursor-pointer hover:scale-102 hover:shadow-md hover:z-10',
        isPositive 
          ? 'bg-gradient-to-br from-success/5 to-success/10 border-success/20 hover:from-success/10 hover:to-success/15 hover:border-success/30' 
          : 'bg-gradient-to-br from-destructive/5 to-destructive/10 border-destructive/20 hover:from-destructive/10 hover:to-destructive/15 hover:border-destructive/30'
      )}
